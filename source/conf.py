...
call(['git', 'clone', 'https://github.com/seenrobotics/dynamic-pros-template.git'])
call(['doxygen', 'Doxyfile'])

# make source
call(['python', './make_source.py', './dynamic-pros-template/src/', './'])
...
project = 'dynamic-pros-template'
copyright = "2019, seenrobotics"
author = "Sean D'Souza"
